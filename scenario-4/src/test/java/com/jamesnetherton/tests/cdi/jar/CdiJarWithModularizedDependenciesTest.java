package com.jamesnetherton.tests.cdi.jar;
...
import com.jamesnetherton.tests.cdi.jar.bean.Bootstrap;

@RunWith(Arquillian.class)
public class CdiJarWithModularizedDependenciesTest {

    @Deployment
    public static JavaArchive createWarDeployment() {
        return ShrinkWrap.create(JavaArchive.class, "camel-jar.jar")
            .setManifest(new StringAsset("Dependencies: org.apache.camel services export\n"))
            .addAsManifestResource(EmptyAsset.INSTANCE, "beans.xml")
            .addPackage(Bootstrap.class.getPackage())
            .addPackage(CdiJarWithModularizedDependenciesTest.class.getPackage());
    }
